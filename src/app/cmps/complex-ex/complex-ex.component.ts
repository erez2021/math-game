...
@Component({
  selector: 'app-complex-ex',
  templateUrl: './complex-ex.component.html',
  styleUrls: ['./complex-ex.component.scss']
})
export class ComplexExComponent implements OnInit {
  ...
  public mistakeCounter: number = 0
    ...
    ngOnInit(): void {
      ...
      this.exercise =  this.numberService.getComplexExercise()
      this.exercise.solution = (this.exercise.num1*this.exercise.num2)%this.exercise.num3
    }
    getSolution(){
