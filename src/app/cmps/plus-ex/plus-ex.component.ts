...
@Component({
  selector: 'app-plus-ex',
  templateUrl: './plus-ex.component.html',
  styleUrls: ['./plus-ex.component.scss']
})
export class PlusExComponent implements OnInit {
...
private interval 
  ...
  ngOnInit(): void {
    ...
    this.exercise.num2 =  this.numberService.getRandomInt(0,(20-this.exercise.num1))
